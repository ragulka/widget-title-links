...
# main config
PLUGINSLUG="widget-title-links"
CURRENTDIR=`pwd`
MAINFILE="widget-title-links.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/widget-title-links/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="ragulka" # your svn username
